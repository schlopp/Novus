...
async def menu_demo(ctx):  # define a dummy command
    ...
    embed = discord.Embed(
        title="Example", color=0x68B38C
    )  # create a embed as structure
    ...
    options = [
        discord.ui.SelectOption(label="entry 1", value="entry 1"),
        discord.ui.SelectOption(label="entry 2", value="entry 2"),
    ]  # define a list with our options
